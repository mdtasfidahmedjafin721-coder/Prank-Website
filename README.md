...
<title>Security Alert 😈</title>  <style>  
  * {  
  ...
  <div class="icon">⚠️</div>    <h1>SECURITY ALERT</h1>    <p>অস্বাভাবিক কার্যকলাপ শনাক্ত হয়েছে!</p>    <p id="status">Checking device...</p>  <button onclick="reveal()">Check Result</button>
